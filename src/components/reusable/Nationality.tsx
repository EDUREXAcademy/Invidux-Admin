...
export function Nationality() {
  return (
    <>
    <label htmlFor="Country" className="block text-neutral-950 text-sm font-normal mb-[6px]">
      Resident Country
    </label>
    <Select>
      <SelectTrigger className="w-[343px] md:w-[486px] h-12 px-2 bg-white rounded-[7px] border border-zinc-500 text-zinc-500 outline-none focus-within appearance-none text-base font-normal leading-normal focus:bg-white disabled:opacity-75 disabled:hover:cursor-not-allowed mb-4">
        <SelectValue placeholder="Country" />
      </SelectTrigger>
      <SelectContent className ='bg-white outline-none focus-within appearance-none'>
        <SelectGroup>
          <SelectLabel>Resident Country</SelectLabel>
