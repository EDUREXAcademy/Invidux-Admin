...
const TokenDisplay = ({asset}: Props) => {
  return (
      <Link href="/token-issuers/invest/asset-details" className='w-full cursor-pointer'>
          <div
          ...
          <div className="h-fit rounded-b-md shadow-3xl p-4 flex flex-col gap-y-5">
              ...
              <div className='font-light text-[#585978] flex flex-col gap-y-1.5'>
                  ...
                  {/* Progress Bar */}
                  <Progress value={33} className='w-full h-2 bg-[#E7DDC8]' />
              ...
              <div className='flex flex-col gap-y-1 mt-auto font-["Inter"]'>
                  <div className='flex justify-between'>
