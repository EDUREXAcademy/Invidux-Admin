      ...
      <div className="bg-[#F0F2F5] py-5 px-4 md:px-8 flex flex-col gap-y-4">
        <div className="w-full grid grid-cols-10 gap-x-[10px] overflow-x-auto">
          <div className="h-[179px] bg-black col-span-4 text-white px-8 py-9 rounded-md flex flex-col justify-between">
            ...
            <div className="">
              <p className="font-light mb-1 text-sm text-[#D8D8D8]">
                Wallet balance
              </p>
          ...
          <div className="h-[179px] border border-[#585978] col-span-3 text-black px-6 py-9 rounded-md flex flex-col justify-between">
            ...
            <div className="">
              <p className="font-light mb-1 text-sm text-[#585978]">
                Total Property Issued
              </p>
              <div className="flex justify-between items-center">
                <div className="flex gap-3 items-center">
                  <p
                    className={`text-xl md:text-2xl ${
                      blurPropertyIssued && "blur-[5px] "
                    }`}
                  >
                    ₦239,000,000
                  </p>
                  <button
                    onClick={() => setBlurPropertyIssued((prev) => !prev)}
                  >
          ...
          <div className="h-[179px] border border-[#585978] col-span-3 text-black px-6 py-9 rounded-md flex flex-col justify-between">
            ...
            <div className="">
              <p className="font-light mb-1 text-sm text-[#585978]">
                Total Property Reserved
              </p>
              <div className="flex justify-between items-center">
                <div className="flex gap-3 items-center">
                  <p
                    className={`text-xl md:text-2xl ${
                      blurPropertyReserved && "blur-[5px] "
                    }`}
                  >
                    ₦239,000,000
                  </p>
                  <button
                    onClick={() => setBlurPropertyReserved((prev) => !prev)}
                  >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-2 lg:gap-x-8 my-1">
          <div className="flex items-center gap-4 bg-white rounded-md p-4">
            ...
            <div>
              <p className="text-[#585978] text-xs md:text-sm">
                All Properties
              </p>
                ...
                <tbody className=" bg-white h-full text-sm">
                  {[...Array(10)].map((transaction, index) => (
                    <tr key={index} className={``}>
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">₦948.55</td>
                      <td className="px-4 py-4 whitespace-nowrap">
                        12th Jan, 2023
                      </td>
                    </tr>
              ...
              <div className="col-span-5">
                <div className="col-span-1 p-2 bg-white rounded-md">
                  <div className="flex justify-between">
                    ...
                    <Link
                      href="/token-issuers/reviews"
                      className="text-[#585978] underline text-sm"
                    >
                      See all
                    </Link>
                  </div>
                  <div className=" w-full h-[350px] overflow-y-auto mt-3 flex flex-col gap-y-4">
                    {[...Array(15)].map((review, index) => (
                      <div
                        key={index}
                        className="w-52 h-14 justify-start items-start gap-0.5 inline-flex"
                      >
                        <div className="justify-start items-start gap-2 flex">
                          ...
                          <div className="flex-col justify-start items-start inline-flex gap-y-1">
                            <div className="flex-col justify-start items-start flex gap-0.5">
                              <div className="w-28 text-slate-900 text-sm font-medium">
                                INVLEKKI102
                              </div>
                              <div className="w-28 text-slate-600 text-xs font-normal">
                                Lekki Phase 1
                              </div>
                            </div>
                            <div className="text-slate-400 text-xs font-medium font-['Inter'] leading-none">
                              2h ago
                            </div>
                          </div>
                        </div>
              ...
              <div className="col-span-6">
                <div className="col-span-1 p-2 bg-white rounded-md">
                  <div className="flex justify-between">
                    ...
                    <Link
                      href="/token-issuers/notifications"
                      className="text-[#585978] underline text-sm"
                    >
                      See all
                    </Link>
                  ...
                  <div className=" w-full h-[350px] overflow-y-auto mt-3 flex flex-col gap-y-4">
                    {[...Array(15)].map((review, index) => (
                      <div
                        key={index}
                        className=" justify-start items-start gap-0.5 inline-flex"
                      >
                        <div className="justify-start items-start gap-2 flex">
